    ...
    Construct.prototype = {
        ...
        init: function() {
            ...
            $('script').each(function(i, s) {
                if (s.src) {
                    if (s.src.match(/\/redactor\.min\.js.*$/))
                        this.opts.path = s.src.replace(/redactor\.min\.js(\?.*)?$/, '');
                    else if (s.src.match(/\/redactor\.js.*$/))
                        this.opts.path = s.src.replace(/redactor\.js(\?.*)?$/, '');
                }
            }
            .bind2(this));
        ...
        restoreSelection: function() {
            if (this.cursorPosition) {
                ...
                } else if (document.selection && this.cursorPosition.select)
		...
		*/
        ...
        showFile: function() {
            ...
            var handler = function() {
                ...
                if (this.opts.fileUploadFunction)
                    params = this.opts.fileUploadFunction();
        ...
        showImage: function() {
            ...
            var handler = function() {
                ...
                if (this.opts.imageUploadFunction)
                    params = this.opts.imageUploadFunction();
        ...
        uploadLoaded: function() {
            ...
            if (i.contentDocument)
                ...
                var d = window.frames[this.id].document;
